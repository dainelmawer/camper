...
if ( ! function_exists( 'camper_setup' ) ) :
	...
	function camper_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'camper' ),
		) );
...
function camper_scripts() {
	wp_enqueue_style( 'camper-style', get_stylesheet_uri() );

	wp_enqueue_script( 'camper-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'camper-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
